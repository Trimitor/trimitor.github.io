...
function doQuestHelper(_caverns) {
    ...
    let vcont = "-- Generated by WDM Collection\n";
    _caverns.worldMapArea.filter(cavern => !CONTINENTS.includes(cavern[1]) && _caverns.dungeonType.find(dungeon => dungeon[0] === cavern[0])[1] === 1).forEach((cavern, key) => {
        console.log(cavern);
    });
